 ...
 *
 * To make things a bit easier she only uses the cards 1 to 10 so her stack of cards can be represented by an array of
 * numbers. The position of a certain card corresponds to the index in the array. That means position 0 refers to the
 * first card, position 1 to the second card etc.
 ...
 *
 * Perform some sleight of hand and exchange the card at index position with the replacement card provided. Return the
 * adjusted stack.
 *
 * const position = 2;
