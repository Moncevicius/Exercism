 ...
 * Instructions
 *
 * You are an avid bird watcher that keeps track of how many birds have visited your garden. Usually, you use a tally
 * in a notebook to count the birds but you want to better work with your data. You already digitalized the bird counts
 * per day for the past weeks that you kept in the notebook.
 *
 * Now you want to determine the total number of birds that you counted, calculate the bird count for a specific week
 * and correct a counting mistake.
 * Note
 *
 ...
 * started your logs.
 *
 * Implement a function totalBirdCount that accepts an array that contains the bird count per day. It should return the
 * total number of birds that you counted.
 *
 ...
 *
 * Implement a function birdsInWeek that accepts an array of bird counts per day and a week number. It returns the
 * total number of birds that you counted in that specific week. You can assume weeks are always tracked completely.
 *
 * birdsPerDay = [2, 5, 0, 7, 4, 1, 3, 0, 2, 5, 0, 1, 3, 1];
